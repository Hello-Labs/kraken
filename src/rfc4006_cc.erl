...
-export_records([hello_CCR, hello_CCA,
		 'hello_Cost-Information', 'hello_Unit-Value',
		 'hello_Multiple-Services-Credit-Control',
		 'hello_Granted-Service-Unit',
		 'hello_Requested-Service-Unit',
		 'hello_Used-Service-Unit', 'hello_CC-Money',
		 'hello_G-S-U-Pool-Reference',
		 'hello_Final-Unit-Indication', 'hello_Redirect-Server',
		 'hello_Service-Parameter-Info', 'hello_Subscription-Id',
		 'hello_User-Equipment-Info', 'hello_Proxy-Info',
		 'hello_Failed-AVP', 'hello_Experimental-Result',
		 'hello_Vendor-Specific-Application-Id',
		 'hello_E2E-Sequence']).
...
rec2msg(hello_CCR) -> 'CCR';
rec2msg(hello_CCA) -> 'CCA';
rec2msg(_) -> erlang:error(badarg).

msg2rec('CCR') -> hello_CCR;
msg2rec('CCA') -> hello_CCA;
msg2rec(_) -> erlang:error(badarg).

name2rec('Cost-Information') ->
    'hello_Cost-Information';
name2rec('Unit-Value') -> 'hello_Unit-Value';
...
name2rec('Used-Service-Unit') ->
    'hello_Used-Service-Unit';
name2rec('CC-Money') -> 'hello_CC-Money';
name2rec('G-S-U-Pool-Reference') ->
    'hello_G-S-U-Pool-Reference';
name2rec('Final-Unit-Indication') ->
    'hello_Final-Unit-Indication';
name2rec('Redirect-Server') -> 'hello_Redirect-Server';
name2rec('Service-Parameter-Info') ->
    'hello_Service-Parameter-Info';
name2rec('Subscription-Id') -> 'hello_Subscription-Id';
name2rec('User-Equipment-Info') ->
    'hello_User-Equipment-Info';
name2rec('Proxy-Info') -> 'hello_Proxy-Info';
name2rec('Failed-AVP') -> 'hello_Failed-AVP';
name2rec('Experimental-Result') ->
    'hello_Experimental-Result';
name2rec('Vendor-Specific-Application-Id') ->
    'hello_Vendor-Specific-Application-Id';
name2rec('E2E-Sequence') -> 'hello_E2E-Sequence';
...
dict() ->
	...
	[{{"Session-Id"}}, {"Result-Code"}, {"Origin-Host"},
	 ...
	 {'*', ["AVP"]}]}]},
     {name, "rfc4006_cc"}, {prefix, "hello"},
     {vendor, {9999999, "HELLO"}}].
