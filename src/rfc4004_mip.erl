...
-export_records(['AMR', 'AMA', 'HAR', 'HAA',
		 'MIP-MN-AAA-Auth', 'MIP-Originating-Foreign-AAA',
		 'MIP-Home-Agent-Host', 'MIP-FA-to-MN-MSA',
		 'MIP-FA-to-HA-MSA', 'MIP-HA-to-FA-MSA',
		 'MIP-HA-to-MN-MSA', 'MIP-MN-to-FA-MSA',
		 'MIP-MN-to-HA-MSA', 'Proxy-Info', 'Failed-AVP',
